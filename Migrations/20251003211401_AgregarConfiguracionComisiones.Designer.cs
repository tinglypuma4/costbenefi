...
namespace costbenefi.Migrations
{
    ...
    [Migration("20251003211401_AgregarConfiguracionComisiones")]
    partial class AgregarConfiguracionComisiones
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("costbenefi.Models.ConfiguracionBascula", b =>
                {
                    ...
                    b.Property<string>("TerminadorLinea")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("costbenefi.Models.ConfiguracionComisiones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("TerminalCobraIVA")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);
                    ...
                    b.ToTable("ConfiguracionesComisiones");
                });
            ...
            modelBuilder.Entity("costbenefi.Models.DetalleVenta", b =>
                {
                    ...
                    b.Property<string>("MotivoDescuentoDetalle")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("TieneDescuentoManual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("PrecioOriginal");

                    b.HasIndex("RawMaterialId");

                    b.HasIndex("ServicioVentaId");

                    b.HasIndex("TieneDescuentoManual");
            ...
            modelBuilder.Entity("costbenefi.Models.LoteFabricacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("CantidadObtenida")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("CantidadPlanificada")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("CostoManoObraReal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("CostoMaterialesReal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("CostosAdicionalesReal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<string>("NotasProduccion")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("OperadorResponsable")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("costbenefi.Models.ProcesoFabricacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("CostoEnergia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<string>("DescripcionOtrosCostos")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IncluirCostoEmpaque")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<bool>("IncluirCostoEnergia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<bool>("IncluirCostoTransporte")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<bool>("IncluirOtrosCostos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int>("TiempoFabricacionMinutos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(60);

                    b.Property<string>("TipoFabricacion")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("costbenefi.Models.RecetaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("EsIngredientePrincipal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
                    ...
                    b.Property<string>("NotasIngrediente")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("TEXT");

                    b.Property<int>("OrdenAdicion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("EsIngredientePrincipal");

                    b.HasIndex("OrdenAdicion");
            ...
            modelBuilder.Entity("costbenefi.Models.Venta", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaHoraDescuento")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("MotivoDescuentoGeneral")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("TieneDescuentosAplicados")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<string>("TipoUsuarioAutorizador")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("TotalDescuentosAplicados")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<string>("UsuarioAutorizadorDescuento")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TieneDescuentosAplicados");

                    b.HasIndex("TipoUsuarioAutorizador");

                    b.HasIndex("Usuario");

                    b.HasIndex("UsuarioAutorizadorDescuento");
            ...
            modelBuilder.Entity("costbenefi.Models.LoteFabricacion", b =>
                {
                    b.HasOne("costbenefi.Models.ProcesoFabricacion", "ProcesoFabricacion")
                        .WithMany("LotesFabricados")
                        .HasForeignKey("ProcesoFabricacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("costbenefi.Models.RawMaterial", "ProductoResultante")
                        .WithMany()
